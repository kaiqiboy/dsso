bash /home/xx/spark-3.2.1-bin-hadoop3.2/bin/spark-submit\
    ...
    --conf spark.sql.ceoDir=/home/xx/dsso/dsso-deploy\
    ...
    /home/xx/dsso/dsso-test/target/scala-2.12/sql-opt_2.12-0.1.jar /datasets/tpch100 /home/xx/dsso/data/tpch/queries_test/1.sql 0 /datasets/test /home/xx/dsso/tmp 
