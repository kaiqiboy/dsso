...
class ImdbDataGenerator(dataDir: String) extends DataGenerator {
  ...
  def createTable: Unit = {
    ...
    charNameDf.write.mode("overwrite").saveAsTable("char_name")
    compCastTypeDf.write.mode("overwrite").saveAsTable("comp_cast_type")
    companyNameDf.write.mode("overwrite").saveAsTable("company_name")
    companyTypeDf.write.mode("overwrite").saveAsTable("company_type")
    completeCastDf.write.mode("overwrite").saveAsTable("complete_cast")
    infoTypeDf.write.mode("overwrite").saveAsTable("info_type")
    keywordDf.write.mode("overwrite").saveAsTable("keyword")
    kindTypeDf.write.mode("overwrite").saveAsTable("kind_type")
    linkTypeDf.write.mode("overwrite").saveAsTable("link_type")
    movieCompaniesDf.write.mode("overwrite").saveAsTable("movie_companies")
    movieInfoDf.write.mode("overwrite").saveAsTable("movie_info")
    movieInfoIdxDf.write.mode("overwrite").saveAsTable("movie_info_idx")
    movieKeywordDf.write.mode("overwrite").saveAsTable("movie_keyword")
    movieLinkDf.write.mode("overwrite").saveAsTable("movie_link")
    nameDf.write.mode("overwrite").saveAsTable("name")
    personInfoDf.write.mode("overwrite").saveAsTable("person_info")
    roleTypeDf.write.mode("overwrite").saveAsTable("role_type")
    titleDf.write.mode("overwrite").saveAsTable("title")
