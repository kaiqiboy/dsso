...
abstract class Catalog {
  ...
  var pruneSimilar: String = "none"

  var candidatePlans: Option[Seq[SparkPlan]] = None

  var deleteTmpCeoFiles: Boolean = true

  var tableMetadata: Array[TableInfo] = new Array[TableInfo](0)

  var smallColumns: Set[String] = new Array[String](0).toSet
  /**
